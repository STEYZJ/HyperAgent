...
COMMAND_REGISTRY: List[SlashCommandDef] = [
    ...
    SlashCommandDef("sessions", "List saved conversation sessions", "Session", cli_command="session-list"),
    ...
    SlashCommandDef("skills", "List, browse, inspect, install, or run skills", "Skills", aliases=("skill",), cli_command="skill-list"),
    ...
    SlashCommandDef("platforms", "Show channel platform registry status", "Integrations", cli_command="channel-list", gateway_allowed=True),
